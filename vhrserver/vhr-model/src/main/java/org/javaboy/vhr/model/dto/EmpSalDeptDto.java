...
public class EmpSalDeptDto {
    ...
    public EmpSalDeptDto(Integer eid, Integer basicSalary, Integer bonus, Integer lunchSalary, Integer trafficSalary, Integer allSalary, Integer pensionBase, Float pensionPer, Integer medicalBase, Float medicalPer, Integer accumulationFundBase, Float accumulationFundPer, Integer unemploymentBase, Float unemploymentPer, Integer takeHome, String name, String email, String phone, String dname) {
        this.eid = eid;
    ...
    public EmpSalDeptDto(Integer id, Integer eid, Integer basicSalary, Integer bonus, Integer lunchSalary, Integer trafficSalary, Integer allSalary, Integer pensionBase, Float pensionPer, Integer medicalBase, Float medicalPer, Integer accumulationFundBase, Float accumulationFundPer, Integer unemploymentBase, Float unemploymentPer, Integer takeHome, String name, String email, String phone, String dname) {
        this.id = id;
        this.eid = eid;
        this.basicSalary = basicSalary;
        this.bonus = bonus;
